...
export default function SolsticeSignal() {
  ...
  async function runSignal() {
    setStatus("Sampling Base network…");
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 960, margin: "60px auto", fontFamily: "system-ui" }}>
        <h1>SolsticeSignal — Built for Base</h1>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <button onClick={runSignal} style={{ padding: "6px 12px" }}>
            Run Signal
          </button>
        ...
        <div style={{ marginTop: 20, lineHeight: 1.75 }}>
